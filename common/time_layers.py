...
class TimeRNN:
    ...
    def backward(self, dhs):
        ...
        for t in reversed(range(T)):
            layer = self.layers[t]
            dx, dh = layer.backward(dhs[:, t, :] + dh)  # �ջ�� ����
            dxs[:, t, :] = dx
...
class TimeSoftmaxWithLoss:
    ...
    def forward(self, xs, ts):
        ...
        ls *= mask  # ignore_label�� �ش��ϴ� �����ʹ� �ս��� 0���� ����
        loss = -np.sum(ls)
        loss /= mask.sum()
    ...
    def backward(self, dout=1):
        ...
        dx *= dout
        dx /= mask.sum()
        dx *= mask[:, np.newaxis]  # ignore_label�� �ش��ϴ� �����ʹ� ���� 0���� ����
